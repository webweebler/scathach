         ...
         <div class="gallery-wrapper">
                ...
                <div class="scroll-container horizontal-scroll-wrapper">
                    ...
                    <div class="gallery-img-wrapper">
                        <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" class="lightbox-trigger" data-lightbox="<?php echo esc_url($image_url); ?>">
                    </div>
                    <?php
                            endif;
                        endwhile;
                    ...
                    ?>
                    <div class="gallery-img-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/images/scathachPic1.jpg" alt="Gallery Image" class="lightbox-trigger" data-lightbox="<?php echo get_template_directory_uri(); ?>/images/scathachPic1.jpg"></div>
                    <div class="gallery-img-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/images/taylorLily.jpg" alt="Gallery Image" class="lightbox-trigger" data-lightbox="<?php echo get_template_directory_uri(); ?>/images/taylorLily.jpg"></div>
                    <div class="gallery-img-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/images/scathachGalleryPic3.jpg" alt="Gallery Image" class="lightbox-trigger" data-lightbox="<?php echo get_template_directory_uri(); ?>/images/scathachGalleryPic3.jpg"></div>
                    <div class="gallery-img-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/images/scathachGalleryPic2.jpg" alt="Gallery Image" class="lightbox-trigger" data-lightbox="<?php echo get_template_directory_uri(); ?>/images/scathachGalleryPic2.jpg"></div>
                    <div class="gallery-img-wrapper"><img id="galleryLastImg" src="<?php echo get_template_directory_uri(); ?>/images/scathachGalleryPic4.jpg" alt="Gallery Image" class="lightbox-trigger" data-lightbox="<?php echo get_template_directory_uri(); ?>/images/scathachGalleryPic4.jpg"></div>
                    <?php endif; ?>
                </div>
            </div>
        </section>  
