        ...
        <section id="gallery">
         ...
         <div class="gallery-wrapper">
                ...
                <div class="scroll-container horizontal-scroll-wrapper">
                    <?php
                    // Get images from WordPress Media Library with 'gallery' tag or category
                    ...
                    // If no tagged images, get all images
